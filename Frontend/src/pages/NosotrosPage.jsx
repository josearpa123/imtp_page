...
function PageLoader({ onComplete }) {
  ...
  return (
    <div className="nosotros-page-loader" aria-label="Cargando">
...
function NosotrosPage() {
  ...
  const handleWhatsApp = () => {
    window.open(
      "https://wa.me/573207262477?text=Hola,%20quiero%20conocer%20más%20sobre%20IMTP%20Studios",
      "_blank"
    );
  };
  ...
  return (
    <div className="nosotros-page">
      ...
      <main className={`nosotros-main ${isLoading ? "loading" : ""} ${isVisible ? "visible" : ""}`}>
        {/* ===== HERO ===== */}
        <section className="nos-hero">
          ...
          <div className="container">
            <div className="nos-hero-content">
              <div className="hero-badge animate-item" style={{ "--delay": "0.08s" }}>
                <span className="badge-pulse"></span>
                Estudio de tecnología en Cali, Colombia
              </div>

              <h1 className="nos-hero-title animate-item" style={{ "--delay": "0.14s" }}>
                Construimos software
                <span className="title-gradient"> que funciona.</span>
              </h1>

              <p className="nos-hero-desc animate-item" style={{ "--delay": "0.20s" }}>
                No somos una agencia. Somos un estudio técnico que diagnostica problemas reales y
                construye soluciones a medida. Sin intermediarios, sin plantillas, sin sorpresas.
              </p>

              <div className="nos-hero-actions animate-item" style={{ "--delay": "0.26s" }}>
            ...
            <div className="container">
              <div className="stats-row">
                {stats.map((stat, idx) => (
                  <div
                    key={idx}
                    className="stat-block animate-item"
                    style={{ "--delay": `${0.34 + idx * 0.06}s` }}
                  >
          ...
          <div className="container">
            <div className="historia-layout">
              <div className="historia-text">
                <span className="nos-label animate-item" style={{ "--delay": "0.08s" }}>
                  Nuestra historia
                </span>
                <h2 className="nos-title animate-item" style={{ "--delay": "0.14s" }}>
                  Nacimos para resolver<br />problemas reales.
                </h2>

                <div className="historia-paragraphs">
                  <p className="animate-item" style={{ "--delay": "0.20s" }}>
                    IMTP Studios nació de una frustración común: empresas pagando por soluciones genéricas
                    que no resolvían sus problemas reales.
                  </p>
                  <p className="animate-item" style={{ "--delay": "0.26s" }}>
                    Decidimos hacer las cosas diferente. Primero escuchamos, después diagnosticamos, y solo entonces
                    proponemos. No vendemos tecnología por vender — <strong>vendemos resultados.</strong>
                  </p>
                  <p className="animate-item" style={{ "--delay": "0.32s" }}>
                    Hoy trabajamos con empresas de todos los tamaños en Colombia, siempre con el mismo enfoque:
                    entender antes de construir.
                  </p>
                </div>
              </div>

              <div className="historia-visual animate-item" style={{ "--delay": "0.22s" }}>
                  ...
                  <div className="code-body">
                    <pre>
                      <code>
                        ...
                        <span className="code-var">imtp</span>{" "}
                        <span className="code-op">=</span> {"{"}{"\n"}
                        {"  "}
                        <span className="code-prop">enfoque</span>:{" "}
                        <span className="code-string">"diagnóstico primero"</span>,{"\n"}
                        {"  "}
                        <span className="code-prop">equipo</span>:{" "}
                        <span className="code-string">"sin intermediarios"</span>,{"\n"}
                        {"  "}
                        <span className="code-prop">código</span>:{" "}
                        <span className="code-string">"limpio y escalable"</span>,{"\n"}
                        {"  "}
                        <span className="code-prop">soporte</span>:{" "}
                        <span className="code-string">"post-entrega"</span>
                        {"\n"}
                        {"}"};{"\n\n"}
        ...
        <section className="nos-equipo">
          <div className="container">
            <div className="nos-section-header">
              ...
              <h2 className="nos-title animate-item" style={{ "--delay": "0.14s" }}>
                Las personas detrás de tu proyecto.
              </h2>
              <p className="nos-subtitle animate-item" style={{ "--delay": "0.20s" }}>
            ...
            <div className="equipo-cards">
              {equipo.map((persona, i) => (
                <article
                  key={persona.id}
                  className="persona-card animate-item"
          ...
          <div className="container">
            ...
            <div className="valores-cards">
              {valores.map((valor, idx) => (
                <div
                  key={idx}
                  className="valor-item animate-item"
                  style={{ "--delay": `${0.20 + idx * 0.06}s` }}
                >
            ...
            <div className="stack-content">
              ...
              <div className="stack-tags">
                {tecnologias.map((tech, idx) => (
                  <span
                    key={idx}
                    className="stack-tag animate-item"
                    style={{ "--delay": `${0.18 + idx * 0.03}s` }}
                  >
                    {tech}
                  </span>
                ))}
          ...
          <div className="container">
            <div className="ubicacion-layout">
              <div className="ubicacion-info">
                ...
                <h2 className="nos-title animate-item" style={{ "--delay": "0.14s" }}>
                  Desde Cali, para Colombia.
                </h2>
                <p className="ubicacion-desc animate-item" style={{ "--delay": "0.20s" }}>
                  Trabajamos de forma remota con clientes en todo el país. Reuniones virtuales, comunicación clara,
                  resultados reales.
                </p>

                <div className="contacto-list">
                  <a
                    href="mailto:info@imtpstudios.com"
                    className="contacto-row animate-item"
                    style={{ "--delay": "0.26s" }}
                  >
                  ...
                  <div className="contacto-row animate-item" style={{ "--delay": "0.38s" }}>
                    <div className="contacto-icon">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
              ...
              <div className="ubicacion-map animate-item" style={{ "--delay": "0.24s" }}>
        ...
        <section className="nos-cta">
          <div className="container">
            <div className="cta-box animate-item" style={{ "--delay": "0.10s" }}>
              <div className="cta-glow"></div>
              <div className="cta-inner">
                <h2 className="cta-heading">¿Listo para empezar?</h2>
                <p className="cta-text">
                  Cuéntanos sobre tu proyecto. Sin compromiso, sin presión. Solo una conversación para entender cómo
                  podemos ayudarte.
                </p>
