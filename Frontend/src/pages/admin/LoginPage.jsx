...
export default function LoginPage() {
    ...
    const [error, setError] = useState('') // ✅ estaba, pero ahora lo renderizamos

    const handleEmailSubmit = (e) => {
        e.preventDefault()
        if (!email) return
        setError('') // ✅ limpia errores al avanzar
        setStep('password')
    }
    ...
    const handlePasswordSubmit = async (e) => {
        ...
        try {
            // ✅ fallback a localhost si no tienes VITE_API_URL
            ...
            localStorage.removeItem('imtp_admin') // ya no lo uses
    ...
    return (
        <div className="auth-page-simple">
            ...
            <div className="auth-card-simple">
                ...
                {/* ✅ Error visible */}
                {error && (
                    <div className="auth-error-simple" role="alert">
                        {error}
                    </div>
                )}
