  ...
  return (
    <header className="header">
      <div className="container">
        <div className="header-inner">
          ...
          <nav className="desktop-nav">
            ...
            {/* ✅ Cotizar como item normal del menú */}
            <NavLink to="/cotizar" className={({ isActive }) => isActive ? 'active-link' : ''}>
              Cotizar
            </NavLink>
          </nav>
          ...
          <div className="header-actions">
            ...
            <div className="social-icons">
              ...
              <a href="https://wa.me/+573207262477" target="_blank" rel="noopener noreferrer">
                <svg fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* ✅ Quitado: CTA Cotizar (ya NO va como botón) */}
      ...
      <nav className={`mobile-nav ${menuOpen ? 'mobile-open' : ''}`}>
        ...
        {/* CTA Cotizar Mobile (lo dejo tal cual lo tienes) */}
        <Link to="/cotizar" onClick={() => setMenuOpen(false)} className="mobile-cta">
          Cotizar Proyecto
        </Link>
